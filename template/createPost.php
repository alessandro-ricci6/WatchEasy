        ...
        <div class="modal-body">
            <div class="row g-2">
                ...
                <div class="col-md text-center">
                    <label for="seasonSelect">Season:<select id="seasonSelect" class="form-select mt-2 mx-3" name="seasonSelect" aria-label="Season select" disabled>
                    </select></label>
                    <label for="episodeSelect">Episode: <select id="episodeSelect" class="form-select mt-2 mx-3" name="episodeSelect" aria-label="Episode select" disabled>
                    </select></label>
                </div>
